...
| <a href="#getting-started-manual-header" id="getting-started-manual-header"><code>-H, --header &lt;HEADER&gt;</code></a>                                        | Add an extra header to include in information sent. Can be used several times in a command<br><br>Do not add newlines or carriage returns<br>                                                                                                                                                                                                                                                                                                           |
...
- status line:
  ...
  - [`version`](#file-format-capturing-response-version-capture)
- headers:
...
- body:
  ...
  - [`sha256`](#file-format-capturing-response-sha-256-capture)
  - [`md5`](#file-format-capturing-response-md5-capture)
- others:
  - [`url`](#file-format-capturing-response-url-capture)
  - [`ip`](#file-format-capturing-response-ip-address-capture)
  - [`variable`](#file-format-capturing-response-variable-capture)
  - [`duration`](#file-format-capturing-response-duration-capture)
  - [`certificate`](#file-format-capturing-response-ssl-certificate-capture)
...
Capture the [SHA-256](https://en.wikipedia.org/wiki/SHA-2) hash of the response body.
...
Capture the [MD5](https://en.wikipedia.org/wiki/MD5) hash of the response body.
...
which are redacted from logs and reports, using [`--secret` option](#file-format-templates-secrets):
...
value with [predicates](#file-format-asserting-response-predicates) (like `startsWith`, `contains`, `exists`)you can use the explicit [header assert](#file-format-asserting-response-header-assert).
...
An assert consists of a query followed by a predicate. The format of the query is shared with [captures](#file-format-capturing-response-query), and queries
can extract data from

- status line:
  - [`status`](#file-format-asserting-response-status-assert)
  - [`version`](#file-format-asserting-response-version-assert)
- headers:
...
- others:
  ...
  - [`ip`](#file-format-asserting-response-ip-address-assert)
...
Queries, in asserts and in captures, can be refined with [filters](#file-format-filters), like [`count`][count](#file-format-filters-count) to add tests on collections
sizes.
...
|----------------------|---------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|
| __`==`__             | Query and predicate value are equal                                                   | `jsonpathÂ "$.book"Â ==Â "Dune"`                                                           |
| __`!=`__             | Query and predicate value are different                                               | `jsonpathÂ "$.color"Â !=Â "red"`                                                           |
| __`>`__              | Query number is greater than predicate value                                          | `jsonpathÂ "$.year"Â >Â 1978`                                                              |
| __`>=`__             | Query number is greater than or equal to the predicate value                          | `jsonpathÂ "$.year"Â >=Â 1978`                                                             |
| __`<`__              | Query number is less than that predicate value                                        | `jsonpathÂ "$.year"Â <Â 1978`                                                              |
| __`<=`__             | Query number is less than or equal to the predicate value                             | `jsonpathÂ "$.year"Â <=Â 1978`                                                             |
| __`startsWith`__     | Query starts with the predicate value<br>Value is string or a binary content          | `jsonpathÂ "$.movie"Â startsWithÂ "The"`<br><br>`bytesÂ startsWithÂ hex,efbbbf;`             |
| __`endsWith`__       | Query ends with the predicate value<br>Value is string or a binary content            | `jsonpathÂ "$.movie"Â endsWithÂ "Back"`<br><br>`bytesÂ endsWithÂ hex,ab23456;`               |
| __`contains`__       | Query contains the predicate value<br>Value is string or a binary content             | `jsonpathÂ "$.movie"Â containsÂ "Empire"`<br><br>`bytesÂ containsÂ hex,beef;`                |
| __`matches`__        | Part of the query string matches the regex pattern described by the predicate value   | `jsonpathÂ "$.release"Â matchesÂ "\\d{4}"`<br><br>`jsonpathÂ "$.release"Â matchesÂ /\d{4}/`   |
| __`exists`__         | Query returns a value                                                                 | `jsonpathÂ "$.book"Â exists`                                                              |
| __`isBoolean`__      | Query returns a boolean                                                               | `jsonpathÂ "$.succeeded"Â isBoolean`                                                      |
| __`isCollection`__   | Query returns a collection                                                            | `jsonpathÂ "$.books"Â isCollection`                                                       |
| __`isEmpty`__        | Query returns an empty collection                                                     | `jsonpathÂ "$.movies"Â isEmpty`                                                           |
| __`isFloat`__        | Query returns a float                                                                 | `jsonpathÂ "$.height"Â isFloat`                                                           |
| __`isInteger`__      | Query returns an integer                                                              | `jsonpathÂ "$.count"Â isInteger`                                                          |
| __`isIsoDate`__      | Query string returns a [RFC 3339](https://www.rfc-editor.org/rfc/rfc3339) date (`YYYY-MM-DDTHH:mm:ss.sssZ`)                   | `jsonpathÂ "$.publication_date"Â isIsoDate`                                               |
| __`isNumber`__       | Query returns an integer or a float                                                   | `jsonpathÂ "$.count"Â isNumber`                                                           |
| __`isString`__       | Query returns a string                                                                | `jsonpathÂ "$.name"Â isString`                                                            |
| __`isIpv4`__         | Query returns an IPv4 address                                                         | `ipÂ isIpv4`                                                                             |
| __`isIpv6`__         | Query returns an IPv6 address                                                         | `ipÂ isIpv6`                                                                             |
...
Check value or attributes of a [`Set-Cookie`](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Set-Cookie) response header. Cookie assert consists of the keyword `cookie`, followed
